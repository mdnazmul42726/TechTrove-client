...
const Update = () => {
    ...
    return (
        <div className="pt-36 text-center">
            ...
            <form className="font-[sans-serif] text-[#333] max-w-4xl mx-auto" onSubmit={handleUpdate}>
                <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div className="relative flex items-center">
                        {/* <input type="email" placeholder="Brand name"
                            className="px-2 py-3 bg-white w-full text-sm border-b-2 focus:border-[#007bff] outline-none" /> */}
                        <select id="cars" required name="brandName" defaultValue={previousData?.companyName} className="px-2 py-3 bg-white w-full text-sm border-b-2 focus:border-[#007bff] outline-none">
                    ...
                    <div className="relative flex items-center">
                        {/* <input type="password" placeholder="Password"
                            className="px-2 py-3 bg-white w-full text-sm border-b-2 focus:border-[#007bff] outline-none" /> */}
                        <select id="cars" name="category" defaultValue={previousData?.category} required className="px-2 py-3 bg-white w-full text-sm border-b-2 focus:border-[#007bff] outline-none">
