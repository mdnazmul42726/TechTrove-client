            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <div className="flex flex-col lg:flex-row justify-between gap-8">
                    <div className="w-full lg:w-5/12 flex flex-col justify-center">
                        ...
                        <p className="font-normal text-base leading-6">TechTrove is your one-stop shop for cutting-edge electronics and innovative gadgets from the world's most reputable brands. We are passionate about bringing you the latest and greatest products to enhance your digital life.
